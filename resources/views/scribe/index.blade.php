    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="administracao">
                    <a href="#administracao">Administração</a>
                                    ...
                                    <ul id="tocify-subheader-administracao" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="administracao-POSTapi-admin">
                                <a href="#administracao-POSTapi-admin">Criar novo Administrador</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="administracao-GETapi-admin">
                                <a href="#administracao-GETapi-admin">Listar Administradores</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="administracao-GETapi-admin--id-">
                                <a href="#administracao-GETapi-admin--id-">Detalhes do Administrador</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="administracao-PUTapi-admin--id-">
                                <a href="#administracao-PUTapi-admin--id-">Atualizar Administrador</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="administracao-DELETEapi-admin--id-">
                                <a href="#administracao-DELETEapi-admin--id-">Excluir Administrador</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="autenticacao">
                    <a href="#autenticacao">Autenticação</a>
                                ...
                                <a href="#autenticacao-POSTapi-login">Login de Usuário</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="autenticacao-POSTapi-logout">
                                <a href="#autenticacao-POSTapi-logout">Logout de Usuário</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="clientes">
                    <a href="#clientes">Clientes</a>
                                ...
                                <a href="#clientes-POSTapi-client">Cadastro de Cliente (Público)</a>
                            </li>
                                ...
                                <a href="#clientes-GETapi-client--id-">Detalhes do Cliente</a>
                            </li>
                                ...
                                <a href="#clientes-DELETEapi-client--id-">Excluir Cliente</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
    ...
    <p>Endpoints restritos para usuários com perfil de administrador.</p>

                                <h2 id="administracao-POSTapi-admin">Criar novo Administrador</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Registra um novo usuário com privilégios administrativos (user_type_id = 1) no sistema.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="Administrador Senior"
               data-component="body">
    <br>
<p>Example: <code>Administrador Senior</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="POSTapi-admin"
               value="admin@empresa.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>admin@empresa.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="password"                data-endpoint="POSTapi-admin"
               value="|]|{+-"
               data-component="body">
    <br>
<p>Must be at least 8 characters. Example: <code>|]|{+-</code></p>
                    ...
                    <h2 id="administracao-GETapi-admin">Listar Administradores</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="administracao-GETapi-admin--id-">Detalhes do Administrador</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retorna as informações de perfil de um administrador específico através do seu ID.</p>

<span id="example-requests-GETapi-admin--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/admin/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-admin--id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-admin--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-admin--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-admin--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-admin--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-admin--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-admin--id-" data-method="GET"
      data-path="api/admin/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-admin--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-admin--id-"
                    onclick="tryItOut('GETapi-admin--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-admin--id-"
                    onclick="cancelTryOut('GETapi-admin--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-admin--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-admin--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-admin--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-admin--id-"
               value="1"
               data-component="url">
    <br>
<p>O ID numérico do administrador. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="administracao-PUTapi-admin--id-">Atualizar Administrador</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Permite a alteração dos dados cadastrais (nome e e-mail) de um administrador existente.</p>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"name\": \"João Campos (Moderador)\",
    \"email\": \"admin.joao@empresa.com\",
    \"password\": \"Senha@2026\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>O ID do administrador que será editado. Example: <code>1</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="João Campos (Moderador)"
               data-component="body">
    <br>
<p>Nome completo do administrador. Example: <code>João Campos (Moderador)</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="PUTapi-admin--id-"
               value="admin.joao@empresa.com"
               data-component="body">
    <br>
<p>Endereço de e-mail único para login. Must be a valid email address. Example: <code>admin.joao@empresa.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="password"                data-endpoint="PUTapi-admin--id-"
               value="Senha@2026"
               data-component="body">
    <br>
<p>Nova senha de acesso. Envie apenas se desejar alterar. Must be at least 8 characters. Example: <code>Senha@2026</code></p>
        </div>
        </form>

                    <h2 id="administracao-DELETEapi-admin--id-">Excluir Administrador</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Remove permanentemente um registro de administrador do banco de dados.
<strong>Nota:</strong> Apenas administradores autorizados podem realizar esta ação.</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Usu&aacute;rio deletado com sucesso !&quot;
}</code>
 </pre>
            <blockquote>
            <p>Example response (403):</p>
...
<p>O ID do administrador a ser removido. Example: <code>1</code></p>
    ...
    <p>Endpoints para gerenciar sessões de usuários e obtenção de tokens.</p>

                                <h2 id="autenticacao-POSTapi-login">Login de Usuário</h2>

<p>
</p>

<p>Recebe as credenciais e retorna o token de acesso (Sanctum).</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Credenciais inv&aacute;lidas. Verifique seu e-mail e senha.&quot;
}</code>
 </pre>
    </span>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>E-mail cadastrado no sistema. Must be a valid email address. Example: <code>admin@sistema.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Senha do usuário. Example: <code>123456</code></p>
        </div>
        </form>

                    <h2 id="autenticacao-POSTapi-logout">Logout de Usuário</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Revoga o token de acesso atual do usuário.</p>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>Gerenciamento de dados dos clientes e seus perfis.</p>

                                <h2 id="clientes-POSTapi-client">Cadastro de Cliente (Público)</h2>

<p>
</p>

<p>Cria um novo usuário do tipo 'Cliente' no sistema.
A validação dos dados é feita automaticamente.</p>
...
<span id="execution-results-POSTapi-client" hidden>
    ...
    <pre class="json"><code id="execution-response-content-POSTapi-client"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-client" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-client">
...
<form id="form-POSTapi-client" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-client"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>Lucas</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="POSTapi-client"
               value="contato@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>contato@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="password"                data-endpoint="POSTapi-client"
               value="|]|{+-"
               data-component="body">
    <br>
<p>Must be at least 8 characters. Example: <code>|]|{+-</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="POSTapi-client"
               value="(11) 99999-9999"
               data-component="body">
    <br>
<p>Must not be greater than 20 characters. Example: <code>(11) 99999-9999</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="address"                data-endpoint="POSTapi-client"
               value="v"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="city"                data-endpoint="POSTapi-client"
               value="d"
               data-component="body">
    <br>
...
<span id="execution-results-GETapi-client" hidden>
    ...
    <pre class="json"><code id="execution-response-content-GETapi-client"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-client" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-client">
...
<form id="form-GETapi-client" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-client"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="clientes-GETapi-client--id-">Detalhes do Cliente</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retorna as informações completas de um cliente específico, incluindo dados de endereço e contato.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/client/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="execution-results-GETapi-client--id-" hidden>
    ...
    <pre class="json"><code id="execution-response-content-GETapi-client--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-client--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-client--id-">
...
<form id="form-GETapi-client--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-client--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>O ID numérico do cliente. Example: <code>1</code></p>
            </div>
                    </form>
...
<p>Permite editar as informações de perfil do cliente e os dados de acesso do usuário.</p>
...
<span id="execution-results-PUTapi-client--id-" hidden>
    ...
    <pre class="json"><code id="execution-response-content-PUTapi-client--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-client--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-client--id-">
...
<form id="form-PUTapi-client--id-" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-client--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>O ID do cliente que será editado. Example: <code>1</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="PUTapi-client--id-"
               value="contato@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>contato@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="password"                data-endpoint="PUTapi-client--id-"
               value="|]|{+-"
               data-component="body">
    <br>
<p>Must be at least 8 characters. Example: <code>|]|{+-</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="PUTapi-client--id-"
               value="(11) 99999-9999"
               data-component="body">
    <br>
<p>Must not be greater than 20 characters. Example: <code>(11) 99999-9999</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="address"                data-endpoint="PUTapi-client--id-"
               value="v"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>v</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="city"                data-endpoint="PUTapi-client--id-"
               value="d"
               data-component="body">
    <br>
<p>Must not be greater than 150 characters. Example: <code>d</code></p>
                    ...
                    <h2 id="clientes-DELETEapi-client--id-">Excluir Cliente</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Remove permanentemente o registro do cliente e seu usuário vinculado do sistema.
<strong>Atenção:</strong> Esta operação é irreversível.</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Usu&aacute;rio exclu&iacute;do com sucesso !&quot;
}</code>
 </pre>
            <blockquote>
            <p>Example response (404):</p>
...
<span id="execution-results-DELETEapi-client--id-" hidden>
    ...
    <pre class="json"><code id="execution-response-content-DELETEapi-client--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-client--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-client--id-">
...
<form id="form-DELETEapi-client--id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-client--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>O ID do cliente a ser removido. Example: <code>1</code></p>
            </div>
                    </form>
